 ...
 *  The notation x[i..] denotes the
 * sub-string of x starting from i.
 **we initialized that matrix locally to avoid race condition 
 */
int M[N+1][N+1];
...
int main(int argc, char **argv) {
  ...
  // we are making this function call to be happen in parallel for each pair of string separately
